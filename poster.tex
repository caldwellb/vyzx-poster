...
% \logoleft{\includegraphics[height=3.1cm]{logos/uc-logo-white.eps}}
  ...
  \begin{block}{Example: Untangling Nots}
    ...
    \begin{figure}
        \begin{subfigure}[b]{.69\textwidth}
            ...
            \quad $ (\Z{1}{2}{0} \vyzxstack \vyzxwire) \vyzxcompose (\vyzxwire \vyzxstack \X{2}{1}{0})$
        \end{subfigure}
    ...
    \begin{figure}
        \begin{subfigure}[b]{.69\textwidth}
            ...
            \quad $ (\vyzxwire \vyzxstack \X{2}{1}{0}) \vyzxcompose (\Z{1}{2}{0} \vyzxstack \vyzxwire)$
        \end{subfigure}
        \begin{subfigure}[b]{.3\textwidth}
            \tikzfig{cnot-l}
        \end{subfigure}
    ...
    \(
      \texttt{Lemma CNOT\_R\_PROP\_L : } \texttt{semantics}(\texttt{CNOT}_R) = CNOT_L
    \)
    \begin{figure}[h]
      \tikzfig{cnot-prop}
    \end{figure}
